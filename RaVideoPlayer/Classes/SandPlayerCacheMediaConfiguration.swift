//
//  RaPlayerCacheMediaConfiguration.swift
//  RaVideoPlayer
//
...
import Foundation
open class RaPlayerCacheMediaConfiguration: NSObject, NSCoding, NSCopying{
    public fileprivate(set) var filePath: String?
    public fileprivate(set) var cacheSegments = [NSValue]()
    public var cacheMedia: RaPlayerCacheMedia?
    public var url: URL?
    
    fileprivate let cacheSegmentQueue = DispatchQueue(label: "com.Raplayer.CacheSegmentQueue")
    fileprivate let cacheDownloadInfoQueue = DispatchQueue(label: "com.Raplayer.CacheDownloadInfoQueue")
    ...
    public required convenience init?(coder aDecoder: NSCoder) {
        guard let fileName = aDecoder.decodeObject(forKey: "fileName") as? String,
            ...
            let cacheMedia = aDecoder.decodeObject(forKey:"cacheMedia") as? RaPlayerCacheMedia,
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        let confi = RaPlayerCacheMediaConfiguration()
...
// MARK: - Update
extension RaPlayerCacheMediaConfiguration {
    open func save() {
